...
function updateDisplay() {
    document.getElementById('redTeamName').textContent = gameData.red_team_name || 'RED TEAM';
    document.getElementById('blueTeamName').textContent = gameData.blue_team_name || 'BLUE TEAM';
    ...
    const redTotal = (gameData.r1 || 0) * 30 + (gameData.r2 || 0) * 40 + (gameData.r3 || 0) * 80;
    const blueTotal = (gameData.b1 || 0) * 30 + (gameData.b2 || 0) * 40 + (gameData.b3 || 0) * 80;
    ...
    document.getElementById('overlayMessage').textContent = gameData.overlay_message || '';
}
